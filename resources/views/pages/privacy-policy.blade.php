    ...
    <x-container>
        <div class="max-w-none prose prose-neutral dark:prose-invert lg:prose-lg prose-a:text-blue-500 prose-a:font-normal prose-a:no-underline hover:prose-a:underline prose-a:outline-none focus-visible:prose-a:ring focus-visible:prose-a:ring-blue-500 prose-pre:outline-none focus-visible:prose-pre:ring focus-visible:prose-pre:ring-blue-500">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Pvtw.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Pvtw, accessible from <a href="pvtw.dev" rel="external nofollow noopener" target="_blank">pvtw.dev</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>By email: patrick@pvtw.dev</li>
            </ul>
        </div>
    </x-container>
</x-app-layout>