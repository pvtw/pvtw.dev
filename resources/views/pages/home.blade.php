<x-layouts::app title="Patrick van 't Wout" description="Hi there! My name is Patrick van 't Wout and this is my mystical world of code and hacking." fixed="true">
    <section class="bg-linear-to-b/srgb from-fuchsia-500 from-60% to-gray-100 dark:to-gray-900 via-green-500 via-80% min-h-dvh flex justify-center items-center">
        <div class="flex flex-col-reverse md:flex-row justify-center items-center md:gap-8 p-4 mt-16 md:mt-0">
            <div class="max-w-[24rem] max-h-96 w-full opacity-50 rounded-full overflow-hidden mt-4 md:mt-0">
                <img src="/images/owl.png" alt="Owl" loading="lazy">
            </div>
            <div class="bg-gray-800/50 p-8 max-w-2xl rounded-xl shadow-2xl text-gray-100">
                ...
                <ul class="flex gap-2 mt-4">
                    <li>
                        <a href="mailto:patrick@pvtw.dev" class="w-8 h-8 block outline-none focus-visible:ring-3 focus-visible:ring-blue-500">
                    ...
                    <li>
                        <a href="https://github.com/pvtw" class="w-8 h-8 block outline-none focus-visible:ring-3 focus-visible:ring-blue-500">
                    ...
                    <li>
                        <a href="https://linkedin.com/in/pvtw" class="w-8 h-8 block outline-none focus-visible:ring-3 focus-visible:ring-blue-500">
                    ...
                    <li>
                        <a href="https://x.com/PvtwDev" class="w-8 h-8 block outline-none focus-visible:ring-3 focus-visible:ring-blue-500">
                    ...
                    <li>
                        <a href="https://youtube.com/@pvtw" class="flex items-center w-8 h-8 block outline-none focus-visible:ring-3 focus-visible:ring-blue-500">
